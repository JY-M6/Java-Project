    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="300px">
        <template #default="scope">
          ...
          <el-button link type="primary" @click="getParnterInfo(scope.row)" v-hasPermi="['manage:partner:query']">查询详情</el-button>
...
function resetPwd(row) {
  const _id = row.id
  proxy.$modal.confirm('你确定要重置合作商的密码吗？').then(function() {
